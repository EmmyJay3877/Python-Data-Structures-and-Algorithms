"""
Heap: A type of complete binary tree where each 
parent node is either less than or equal to it's 
child node (min heap) or greater than or equal to 
it's child node (max heap)
"""
...
class MaxHeap:
    ...
    @staticmethod #access the method with or without the instance of the class
